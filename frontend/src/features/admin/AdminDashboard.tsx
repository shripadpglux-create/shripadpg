              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-5">
                ...
                >
                  ...
                  <div className="mt-3 sm:mt-5">
                    ...
                    <p className="mt-0.5 text-xs font-bold text-emerald-700 group-hover:underline flex items-center gap-1">
                      See Green Vacant Matrix →
                    </p>
                  </div>
                </div>

                {/* 2. Occupied / Booked Rooms (Red 🔴 - BookMyShow Standard: Taken / Booked) */}
                <div
                  onClick={() =>
                    setOccupancyExplorerModal({
                      isOpen: true,
                ...
                >
                  ...
                  <div className="mt-3 sm:mt-5">
                    ...
                    <p className="mt-0.5 text-xs font-bold text-rose-600 group-hover:underline flex items-center gap-1">
                      See Red Occupied Matrix →
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-2xl sm:rounded-[2rem] border border-slate-200/80 bg-white p-3.5 sm:p-6 lg:p-7 shadow-sm lg:col-span-12 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                      <div>
                        <h3 className="text-lg font-black text-slate-900">Recent Customers</h3>
                        <p className="text-[11px] font-semibold text-slate-400">Admissions & Booking Registrations</p>
                      </div>

                      <div className="flex items-center gap-1.5">
                        <span className="rounded-full bg-[#e8edf3] text-[#1e3a5f] border border-[#1e3a5f]/20 px-3 py-1 text-[11px] font-black shadow-2xs">
                          Total Registrations: {getTimeFilteredBookings().length}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between pb-2 border-b border-slate-100">
                        <h4 className="text-sm font-black text-slate-800 flex items-center gap-1.5">
                          ...
                          {dashboardSourceFilter === 'all' ? 'All Registrations' : dashboardSourceFilter === 'online' ? 'Online Bookings' : 'Manual Admissions'}
                        </h4>
                        <span className="rounded-full bg-slate-50 text-slate-800 border border-slate-200 px-2.5 py-0.5 text-[10px] font-extrabold">
                          Count: {getTimeFilteredBookings().filter(b => dashboardSourceFilter === 'all' || b.source === dashboardSourceFilter).length}
                        </span>
                      </div>

                      <div className="space-y-3">
                        {getTimeFilteredBookings().filter(b => dashboardSourceFilter === 'all' || b.source === dashboardSourceFilter).length === 0 ? (
                          <div className="p-8 text-center text-slate-400 font-semibold border border-dashed border-slate-200 rounded-3xl text-xs">
                            ...
                            .map((cust) => {
                              ...
                              return (
                                <div
                                  ...
                                  className="flex items-center justify-between p-3 rounded-2xl bg-slate-50/70 border border-slate-100 hover:bg-slate-100/80 hover:border-slate-300 hover:shadow-xs transition cursor-pointer active:scale-[0.99]"
                                >
                                  <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                      <p className="text-xs font-black text-slate-900 truncate">{cust.name}</p>
                                      <p className="text-[10px] font-semibold text-slate-500 truncate">
                                        {formattedPg}
                                      </p>
                                      <p className="text-[10px] font-bold text-slate-500 mt-0.5 truncate flex flex-wrap items-center gap-1.5">
                                        <span>📱 <span className="text-slate-600">{cust.phone}</span></span>
                                        {cust.guardianPhone && cust.guardianPhone !== "N/A" && (
                                          <span>👨‍👩‍👧‍👦 <span className="text-slate-600">{cust.guardianPhone}</span></span>
                                        )}
                                        ...
                                        {cust.createdByRole === "staff" ? (
                                          ...
                                          <span className="text-indigo-800 bg-indigo-50 px-2 py-0.5 rounded-md border border-indigo-200 text-[10px] font-black">
                                            👑 Admin Admitted: {cust.createdBy || "Master Admin"}
                                          </span>
                                        ) : (
                                  ...
                                  <div className="text-right shrink-0 flex items-center gap-2">
                                    <div className="flex flex-col items-end gap-1">
                                      <span className="text-[9px] font-bold text-slate-400 block">{cust.timestamp}</span>
                                    ...
                                    <div className="flex items-center gap-1 shrink-0" onClick={(e) => e.stopPropagation()}>
                                       {hasAllocation && (
                                         <button
                                           ...
                                           style={{ width: "28px", height: "28px", minWidth: "28px", minHeight: "28px", borderRadius: "50%" }}
                                         >
                  ...
                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-xs font-semibold text-slate-400">Showing recent customer registrations</span>
                    <button
